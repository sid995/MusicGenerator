...
export const env = createEnv({
  ...
  server: {
    ...
    GENERATE_EXTEND_SONG: z.string().optional(),
    GENERATE_SPLIT_STEMS: z.string().optional(),
  ...
  runtimeEnv: {
    ...
    GENERATE_EXTEND_SONG: process.env.GENERATE_EXTEND_SONG,
    GENERATE_SPLIT_STEMS: process.env.GENERATE_SPLIT_STEMS,
